...
const char* ssid = "Introduce tu usuario";
...
void loop() {
  ...
  { 
    ...
    client.println("<html>");
    client.println("<head><title>TC1004B</title>");
    client.println("<body>");
    client.println("<h1 align='center'>Prueba WiFi y NodeMCU</h1>");
    client.println("<div style='text-align:center;'>");
    client.println("<br />");            
    client.println("<button onClick=location.href='./?LED=OFF'>LED ON</button>");           
    client.println("<button onClick=location.href='./?LED=ON'>LED OFF</button>");
    client.println("<br />");
    client.println("</div>");
    client.println("</body>");
    client.println("</html>");
